...
func (db *DatabaseMock) SetProcessPriorities(colonyName string, updates []core.PriorityUpdate) ([]core.PriorityUpdateResult, error) { return []core.PriorityUpdateResult{}, nil }
